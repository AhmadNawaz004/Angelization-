...
public class ImpTree extends TotalSupportTree {
	...
	public void outputFPtreeStorage(JTextArea jtaFPDetails) {
		...
		jtaFPDetails.append("Storage = " + storage + " (bytes)"+"\n");
		jtaFPDetails.append("Nodes   = " + numberOfNodes+"\n");
